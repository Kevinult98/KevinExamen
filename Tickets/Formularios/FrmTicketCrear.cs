...
namespace Tickets.Formularios
{
    public partial class FrmTicketCrear : Form
    {
        ...
        private bool Validar()
        {
            ...
            if (MiTicket.MiCliente.IDCliente > 0 && CboxCategoria.SelectedIndex > -1 && !string.IsNullOrEmpty(TxtTitulo.Text.Trim()) && !string.IsNullOrEmpty(TxtDescripcion.Text.Trim()))
            {
                R = true;
            }
            else
