        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarDatosRequeridos(false))
            {
                ...
                if (ObjUsuario.IDUsuario > 0)
                {
                    ...
                    if (Continuar == DialogResult.Yes)
                    {
                        if (MiUsuarioLocal.Editar(Commons.ObjetosGlobales.MiUsuarioDeSistema.IDUsuario))
                        {
        ...
        {      
            ...
            if (ObjUsuarioTemporal.IDUsuario > 0)
            {
                ...
                if (Continuar == DialogResult.Yes)
                {
                    if (CboxVerActivos.Checked)
                    {
                        if (MiUsuarioLocal.Eliminar(Commons.ObjetosGlobales.MiUsuarioDeSistema.IDUsuario))
                        {
                            //se muestra mensaje de éxito y se actualiza la lista 
