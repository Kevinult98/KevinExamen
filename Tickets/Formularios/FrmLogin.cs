...
namespace Tickets.Formularios
{
    public partial class FrmLogin : Form
    {
        ...
        private void BtnCancelar_Click(object sender, EventArgs e)
        {
            ...
            MiBitacora.GuardarAccionEnBitacora("Cierre del Programa desde Login");
            Application.Exit();
        ...
        private void BtnIngresar_Click(object sender, EventArgs e)
        {
            ...
            {               
                ...
                Logica.Bitacora MiBitacora = new Logica.Bitacora();
                ...
                {
                    MiBitacora.GuardarAccionEnBitacora("Intento Fallido de Login por: " + TxtEmail.Text.Trim());
