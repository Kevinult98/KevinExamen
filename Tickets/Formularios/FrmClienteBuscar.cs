    ...
    public partial class FrmClienteBuscar : Form
    {
        ...
        private void BtnSeleccionar_Click(object sender, EventArgs e)
        {
            if (DgvLista.Rows.Count > 0 && DgvLista.SelectedRows.Count == 1)
            {
                ...
                //una vez que ha capturado la info necesaria de las columnas del DGV, puedo pasar estos
                //datos al objeto local MiTicket

                Commons.ObjetosGlobales.FormCrearTiket.MiTicket.MiCliente.IDCliente = IdCliente;
                Commons.ObjetosGlobales.FormCrearTiket.MiTicket.MiCliente.Nombre = Cliente;
