...
namespace Tickets.Commons
{
    public static class ObjetosGlobales
    {
        ...
        public static Logica.Bitacora MiBitacoraLocal = new Logica.Bitacora();
        ...
        public static Formularios.FrmTicketCrear FormCrearTiket = new Formularios.FrmTicketCrear();

        public static Formularios.FrmAtencionDeTickets FormAtencion = new Formularios.FrmAtencionDeTickets();

        public static Formularios.FormBitacora FormBitacora = new Formularios.FormBitacora();
    }
}
